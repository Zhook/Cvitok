...
public class RandomParameters extends Parameters {
    ...
    private float PortionTransparency = 0;
    ...
    public void setPortionTransparency(int min, int max) throws InvalidParameterException {
        if (min < 0) throw new InvalidParameterException("min Portion Transparency < 0");
        if (max < 0) throw new InvalidParameterException("max Portion Transparency < 0");
        if (min > 100) throw new InvalidParameterException("min Portion Transparency > 100");
        if (max > 100) throw new InvalidParameterException("max Portion Transparency > 100");

        PortionTransparency = new ExtRandomFloat().getFloat(min, max) / 100;
    }
    ...
    private float[] getColor() {
        ...
        if (PortionTransparency > random.nextFloat()) {
